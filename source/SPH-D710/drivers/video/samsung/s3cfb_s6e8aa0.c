...
static int s6e8aa0_gamma_ctl(void)
{
	...
	if(lcd.gamma_mode)
		s6e8aa0_write(s6e8aa0_19gamma_set_tbl[lcd.bl], AMS403GF01_GAMMA_PARAM_SET_DATA_COUNT);
	else
		s6e8aa0_write(s6e8aa0_22gamma_set_tbl[lcd.bl], AMS403GF01_GAMMA_PARAM_SET_DATA_COUNT);
